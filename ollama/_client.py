  ...
  def __init__(
    ...
    **kwargs,
    ...
    if api_key or os.getenv('OLLAMA_API_KEY'):
      headers['X-API-Key'] = api_key or os.getenv('OLLAMA_API_KEY')
    if api_secret or os.getenv('OLLAMA_API_SECRET'):
      headers['X-API-Secret'] = api_secret or os.getenv('OLLAMA_API_SECRET')
    self._client = client(
